...
// Konum güncelle
router.post('/konum/update', takipController.updateAracKonum);
...
// KM kayıtı ekle
router.post('/km/add', takipController.addKmKayidi);
...
// Hız kayıtı ekle
router.post('/hiz/add', takipController.addHizKayidi);
